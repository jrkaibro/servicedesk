...
namespace DealerNet.Packages.ServiceDesk
{
    public partial class FrmUpdate : Form
    {
        ...
        public FrmUpdate(IGenexusService genexusService)
        {
        ...
        {
            var f = new FrmConsultarDemanda(_genexusService, null, this);
            f.ShowDialog();
            txtComentario.Focus();
        }

        private void CarregarGridObjetos(int codDemanda)
        {
            var retorno = _genexusService.BuscarDemandaCommit("", codDemanda); //_genexusService.BuscarObjetosPorDemanda(codDemanda);
            ...
            foreach (var history in _genexusService.GetListaObjetosModificados())
            {
                //Criando Registros 
        ...
        private void txtDemanda_Leave(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                var retorno = _genexusService.BuscarDemandaCommit("", codDemanda); //_genexusService.BuscarDemandasCommitadas("versão da base de dados");
